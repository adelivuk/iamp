    ...
    <div>
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 bg-white">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <h4 className="mt-10 text-center text-l text-capitalize uppercase font-bold text-gray-900">
            This procedure enables you to unlock your account with a new password instead of the lost password.
          </h4>
        </div>
